...
from view.sell import SellPage
from view.snipe import SnipePage
from view.farm_bronze_pack import FarmBronzePackPage
...
class GUI(tk.Tk):
    def __init__(self):
        ...
        self._frame = None
        self.built_frames = {
            "sell_page": SellPage(self),
            "snipe_page": SnipePage(self),
            "farm_bronze_pack_page": FarmBronzePackPage(self),
